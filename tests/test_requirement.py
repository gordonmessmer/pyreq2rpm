...
@pytest.mark.parametrize(('version', 'op', 'arg', 'expected'), [
    ...
    ('2.0.0b5', '<=', '2.4.8.1', True),
    ('2.0.post1', '<=', '2.4.8.1', True),
    ('2.4.8', '<=', '2.4.8.*', packaging.requirements.InvalidRequirement),
    ('2.4.8.0', '<=', '2.4.8.*', packaging.requirements.InvalidRequirement),
    ('2.4.8.1', '<=', '2.4.8.*', packaging.requirements.InvalidRequirement),
    ('2.4.8b5', '<=', '2.4.8.*', packaging.requirements.InvalidRequirement),
    ('2.4.8dev5', '<=', '2.4.8.*', packaging.requirements.InvalidRequirement),
    ('2.4.8.post1', '<=', '2.4.8.*', packaging.requirements.InvalidRequirement),
    ('2.0', '<=', '2.4.8.*', packaging.requirements.InvalidRequirement),
    ('2', '<=', '2.4.8.*', packaging.requirements.InvalidRequirement),
    ('2.0.0b5', '<=', '2.4.8.*', packaging.requirements.InvalidRequirement),
    ('2.0.post1', '<=', '2.4.8.*', packaging.requirements.InvalidRequirement),
    ('2.4.8', '<=', '2.4.8b5', False),
    ('2.4.8.0', '<=', '2.4.8b5', False),
    ('2.4.8.1', '<=', '2.4.8b5', False),
    ('2.4.8b5', '<=', '2.4.8b5', True),
    ...
    ('2.0.0b5', '<=', '2', True),
    ('2.0.post1', '<=', '2', False),
    ('2.4.8', '<=', '2.*', packaging.requirements.InvalidRequirement),
    ('2.4.8.0', '<=', '2.*', packaging.requirements.InvalidRequirement),
    ('2.4.8.1', '<=', '2.*', packaging.requirements.InvalidRequirement),
    ('2.4.8b5', '<=', '2.*', packaging.requirements.InvalidRequirement),
    ('2.4.8dev5', '<=', '2.*', packaging.requirements.InvalidRequirement),
    ('2.4.8.post1', '<=', '2.*', packaging.requirements.InvalidRequirement),
    ('2.0', '<=', '2.*', packaging.requirements.InvalidRequirement),
    ('2', '<=', '2.*', packaging.requirements.InvalidRequirement),
    ('2.0.0b5', '<=', '2.*', packaging.requirements.InvalidRequirement),
    ('2.0.post1', '<=', '2.*', packaging.requirements.InvalidRequirement),
    ('2.4.8', '<=', '2.0.0b5', False),
    ('2.4.8.0', '<=', '2.0.0b5', False),
    ('2.4.8.1', '<=', '2.0.0b5', False),
    ('2.4.8b5', '<=', '2.0.0b5', False),
...
def test_requirement(version, op, arg, expected):
    if type(expected) is not bool:
        with pytest.raises(expected):
            pkg_resources.Requirement.parse('foobar {} {}'.format(op, arg))
        return
